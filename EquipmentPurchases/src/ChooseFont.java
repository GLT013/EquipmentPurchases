...
public class ChooseFont {
	...
	private static JComboBox<Object> titleSize;
	...
	public static String ReportColor;
	public static int ReportWeight;
	...
	try {
		if (firstrun == true)
		{
		ChooseFont window = new ChooseFont();
	...
	private void initialize() {
		...
		frmSelectFont.setTitle("Select Font");
		frmSelectFont.setBounds(ReportGUI.frmReportGenerator.getX() + 150,ReportGUI.frmReportGenerator.getY() + 150, 386, 344);
		...
		btnCancel.setIcon(new ImageIcon(ChooseFont.class.getResource("/067861-3d-glossy-blue-orb-icon-alphanumeric-crossing_85x85.png")));
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ReportFont = titleFontName.getSelectedItem().toString();
				ReportSize = titleSize.getSelectedItem().toString();
				ReportColor = font;
				ReportWeight = fontweight;
				frmSelectFont.show(false);
				ReportGUI.PreviewPane();
			}
		});
		btnSave.setIcon(new ImageIcon(ChooseFont.class.getResource("/075748-3d-glossy-blue-orb-icon-business-diskette-save_85x85.png")));
		...
		button_1.setIcon(new ImageIcon(ChooseFont.class.getResource("/075834-3d-glossy-blue-orb-icon-business-magic-wand_85x85.png")));
		button_1.setSelectedIcon(new ImageIcon(ChooseFont.class.getResource("/075834-3d-glossy-blue-orb-icon-business-magic-wand_85x85.png")));
		button_1.setToolTipText("Reset Font");
