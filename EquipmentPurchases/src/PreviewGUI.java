...
public class PreviewGUI {
	...
	private void initialize() {
		...
		frmPreviewGUI.setIconImage(Toolkit.getDefaultToolkit().getImage(PreviewGUI.class.getResource("/075794-3d-glossy-blue-orb-icon-business-gears1-sc44_43x43.png")));
		...
		//frmPreviewGUI.setDefaultCloseOperation(JFrame.);
