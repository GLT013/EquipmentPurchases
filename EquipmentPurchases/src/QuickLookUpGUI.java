...
public class QuickLookUpGUI {	
	...
	public static JLabel lblPoCode;
	...
	public static void run() {
		...
		try {	
			...
			frmQuickLookupGUI.setVisible(true);
	...
	/**
	 * This function populates the project number from the database according to what is selected from the Project field.
	 * @param proj
	 */
	...
	public static void populateProjectNumFromDB(String proj)
	{
		...
		{
			JOptionPane.showMessageDialog(null, "populateProjectNumFromDB" + e.toString());
		}
	...
	public static void populatePartNumFromDB(String partnum)
	{
		...
		{
			JOptionPane.showMessageDialog(null, "populatePartNumFromDB" + e.toString());
		}
	...
	public static void populateProjectFromDB()
	{
        ...
        try {
			...
			JOptionPane.showMessageDialog(null, "populateProjectFromDB" + e.toString());
		}
        try {
			rs.close();
		} catch (SQLException e) {
		
			JOptionPane.showMessageDialog(null, "Error Closing populateProjectFromDB" + e.toString());
		}
	...
	public static void Search()
	{
		...
		{
			commandText = "SELECT PartNumber FROM Equipment_Purchases WHERE UCASE(PartNumber) LIKE " + "'" + search + "%'";
		}
		
		else if (eq2List.isSelectionEmpty())
		{
			commandText = "SELECT PartNumber FROM Equipment_Purchases WHERE UCASE(PartNumber) LIKE " + "'" + search + "%'" + "AND Project = " + "'" + eqList.getSelectedValue().toString() + "'";

		}
		else
		{
			commandText = "SELECT PartNumber FROM Equipment_Purchases WHERE UCASE(PartNumber) LIKE " + "'" + search + "%'" + "AND ProjectNumber = " + eq2List.getSelectedValue().toString() + "AND Project = " + "'" + eqList.getSelectedValue().toString() + "'";
		}
	    ...
	    try {
			...
			{	
				...
				else
				{
					...
					OrderSubmittedDate_lbl.setText(tmp21);			
				}
				...
				{	
					...
					OrderReceived_Date.setText(tmp21);				
				}
				...
				else
				{
					...
					posubmitteddate_lbl.setText(tmp21);
	...
	private void initialize() {
		...
		frmQuickLookupGUI.setIconImage(Toolkit.getDefaultToolkit().getImage(QuickLookUpGUI.class.getResource("/075794-3d-glossy-blue-orb-icon-business-gears1-sc44_43x43.png")));
		...
		OrderSubmitted_chkBox.setBounds(277, 200, 24, 23);
		...
		lblOrderSubmitted.setBounds(307, 204, 93, 14);
		...
		OrderReceived_chkBox.setBounds(277, 244, 24, 23);
		...
		lblOrderReceived.setBounds(307, 248, 93, 14);
		...
		OrderSubmittedDate_lbl.setBounds(307, 224, 93, 14);
		...
		eq2ScrollPane.setBounds(223, 92, 210, 101);
		...
		Vendor_txtField.setBounds(139, 204, 128, 20);
		...
		lblVendor.setBounds(15, 207, 64, 14);
		...
		VendorQuote_txtField.setBounds(139, 238, 128, 20);
		...
		lblVendorQuote.setBounds(15, 241, 126, 14);
		...
		Cost_txtField.setBounds(514, 202, 128, 20);
		...
		lblCost.setBounds(440, 207, 64, 14);
		...
		Quantity_txtField.setBounds(139, 268, 128, 20);
		...
		lblQuantity.setBounds(15, 271, 64, 14);
		...
		lblPoSubmitted.setBounds(307, 292, 93, 14);
		...
		pocode_txtField.setBounds(514, 234, 128, 20);
		...
		posubmitteddate_lbl.setBounds(307, 310, 93, 14);
		...
		shipper_txtField.setBounds(514, 268, 128, 20);
		...
		lblShipper.setBounds(440, 269, 64, 14);
		...
		lblTrackingNumber.setBounds(15, 333, 113, 14);
		...
		trackingnumber_txtField.setBounds(139, 332, 261, 20);
		...
		lblPoCode.setBounds(440, 239, 64, 14);
		...
		btnNewButton.setBounds(247, 510, 128, 128);
		frmQuickLookupGUI.getContentPane().add(btnNewButton);
		
		label = new JLabel("");
		label.setIcon(new ImageIcon(QuickLookUpGUI.class.getResource("/enengineering_transparent_222x33.png")));
		label.setToolTipText("EN Engineering");
		label.setBounds(15, 617, 222, 33);
		frmQuickLookupGUI.getContentPane().add(label);
		
		label_2 = new JLabel("");
		label_2.setText(MainMenuGUI.version);
		label_2.setHorizontalAlignment(SwingConstants.CENTER);
		label_2.setBounds(580, 626, 72, 14);
		frmQuickLookupGUI.getContentPane().add(label_2);
